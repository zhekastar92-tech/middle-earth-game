...
const DUNGEONS = {
  ...
  river: {
    ...
    bossReward: {
      ...
      guaranteedRarity: 'rare',
      epicChance: 0.07,
      bonusChestChance: 0.15,      // 15% шанс бонусного сундука
      bonusChestEpicChance: 0.20,  // из них 20% огромный, 80% большой
      bonusUniqueEpicChance: 0.007 // 0.7% эпик с уникальным свойством
    }
  },

  // === 3-4. СЮДА ДОБАВЛЯТЬ НОВЫЕ ДАНЖИ ===
...
function checkMobSubmitTrigger(mob, playerDmgThisTurn) {
  ...
  // Активируется снова после окончания предыдущего эффекта
