...
function checkMobSubmitTrigger(mob, playerDmgThisTurn) {
  ...
  // Если дракон нанёс урон игроку — сбрасываем счётчик doom
  if (mob.abilities.includes('doom') && playerDmgThisTurn === 0 && mob.doomNoHitTurns !== undefined) {
    // счётчик тикает в preCheck уже
  }
