...
function switchTab(btn, tabId) {
  ...
  if (tabId === 'tab-battle') {
    let battleActive = document.getElementById('battle-screen') && document.getElementById('battle-screen').style.display !== 'none';
    if (!battleActive) renderMainMenu();
  }
...
function startGame() {
  ...
  // Сначала скрываем main-screen и показываем battle-screen,
  // чтобы switchTab не вызвал renderMainMenu() поверх боя
  document.getElementById("main-screen").style.display = "none";
  document.getElementById("battle-screen").style.display = "block";
  updateScreen(); switchTab(null, "tab-battle");
  // Скрываем карточку ДО анимации входа
