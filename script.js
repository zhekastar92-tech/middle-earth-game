...
function renderPremiumShop() {
  ...
  let html = `
    ...
    <!-- Косметика (скоро) -->
    <div class="class-card" style="border:2px solid #374151; background:rgba(15,20,30,0.7); margin-bottom:16px; text-align:left; opacity:0.7;">
      <div class="class-title" style="color:#94a3b8; margin-bottom:4px;">✨ Косметика</div>
      <div class="class-desc">Уникальные облики и эффекты.</div>
      <div style="margin-top:12px; text-align:center; color:#475569; font-size:13px; font-style:italic; padding:10px;">⏳ Скоро</div>
    </div>
