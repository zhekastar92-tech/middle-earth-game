...
// Проверка триггеров умений моба ДО хода (без submit — он после боя)
...
// БАГ-ФИКС 3: «Подчинись мне» — проверяется ПОСЛЕ боя, когда урон уже нанесён
...
function playTurn(playerChoice) {
  ...
  // БАГ-ФИКС 3: submit проверяем ПОСЛЕ боя — урон уже в lastPlayerDmgThisTurn
  if (bot.isMob) {
